...
class ResNetFeatures(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False):
        ...
        self.lat8 = nn.Conv2d(128, 64, 1)
        self.lat16 = nn.Conv2d(256, 64, 1)
        self.lat32 = nn.Conv2d(512, 64, 1)
        self.bn8 = nn.GroupNorm(16, 64)
        self.bn16 = nn.GroupNorm(16, 64)
        self.bn32 = nn.GroupNorm(16, 64)
